== vertx-forge-addon
:idprefix: id_ 
(choose one, do not modify, then add a second sentence with a brief description, starting with - "The vertx-forge-addon addon enables blah blah...)
...
----
<dependency>
   <groupId>org.vertx.forge.addon</groupId>
